...
public class RestaurantController {
    ...
    @GetMapping(value = "/restaurants/name/{name}/city/{city}", produces = {"application/json"})
    public ResponseEntity<?> listRestaurantNameCity(@PathVariable String name, @PathVariable String city) {
    ...
    public ResponseEntity<?> addNewRestaurant(@Valid @RequestBody Restaurant newRestaurant) throws URISyntaxException {
